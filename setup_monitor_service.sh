sudo wget --no-check-certificate https://raw.githubusercontent.com/bibicadotnet/monitor-service-status/main/monitor_service.sh -O /usr/local/bin/monitor_service.sh
